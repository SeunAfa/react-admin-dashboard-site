...
// Determine the initial selected state based on the current path
const getInitialSelected = (path) => {
  switch (path) {
    case "/team":
      return "Manage Team";
    case "/contacts":
...
// Initialize the selected item based on the current path
const [selected, setSelected] = useState(getInitialSelected(location.pathname));
const [isCollapsed, setIsCollapsed] = useState(false);

// Update the selected item when the path changes
useEffect(() => {
